 ...
 */
    ...
    namespace BabiPHP\Component\Error\Handler;
    ...
    class PrettyPageHandler extends Handler
    {
        ...
        public function handle()
        {
            if (!$this->handleUnconditionally()) {
                ...
                if (php_sapi_name() === 'cli') {
                    ...
                    if (isset($_ENV['BabiPHP\Component\Error-test'])) {
                        throw new \Exception(
                            'Use handleUnconditionally instead of BabiPHP\Component\Error-test'
            ...
            if ($this->applicationPaths) {
                /* @var \BabiPHP\Component\Error\Exception\Frame $frame */
        ...
        public function addDataTableCallback($label, /* callable */ $callback)
        {
            ...
            $this->extraTables[$label] = function (\BabiPHP\Component\Error\Exception\Inspector $inspector = null) use ($callback) {
                try {
