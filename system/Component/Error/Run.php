 ...
 */
    ...
    namespace BabiPHP\Component\Error;

    use InvalidArgumentException;
    use BabiPHP\Component\Error\Exception\ErrorException;
    use BabiPHP\Component\Error\Exception\Inspector;
    use BabiPHP\Component\Error\Handler\CallbackHandler;
    use BabiPHP\Component\Error\Handler\Handler;
    use BabiPHP\Component\Error\Handler\HandlerInterface;
    ...
    final class Run implements RunInterface
    {
        ...
        public function pushHandler($handler)
        {
            ...
            if (!$handler instanceof HandlerInterface) {
                throw new InvalidArgumentException(
                    ...
                    . "BabiPHP\Component\Error\\Handler\\HandlerInterface"
                );
            }
        ...
        public function register()
        {
            if (!$this->isRegistered) {
                ...
                class_exists("\\BabiPHP\\Component\\Error\\Exception\\ErrorException");
                class_exists("\\BabiPHP\\Component\\Error\\Exception\\FrameCollection");
                class_exists("\\BabiPHP\\Component\\Error\\Exception\\Frame");
                class_exists("\\BabiPHP\\Component\\Error\\Exception\\Inspector");
