...
namespace BabiPHP\Component\Translation\Gettext;
...
class GettextTranslator extends BaseTranslator implements TranslatorInterface
{
	...
	* Constructor. Detects the current language using the environment variables.
		...
		//d		etects the language environment respecting the priority order
		        //h		ttp://p		hp.net/manual/en/function.gettext.php#114062
		        if (empty($language)) {
