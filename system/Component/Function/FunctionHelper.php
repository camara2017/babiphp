...
{
	/**
	 * Build an url using one controller end action.
	 *
	 * @param  string  $route
	 * @param  array  $params
	 * @return string
	 */
	function action($route, array $params = [])
	{
		list($controller, $action) = explode('@', $route);
		$params = (!empty($params)) ? implode($params, '/') : '';

		return APP_BASE_URL . '/' . $controller . '/' . $action . '/' . $params;
	}
}
...
if ( ! function_exists('asset'))
{
	...
	{
		return APP_BASE_URL . WWW_ROOT . trim($asset, '/');
	}
}
...
if ( ! function_exists('secure_asset'))
{
	...
	{
		return 'https://' . trim(Config::get('base_url'), '/') . WWW_ROOT . trim($asset, '/');
	}
}
...
if ( ! function_exists('route'))
{
	 ...
	 * @return string
	 */
	function route($routeName, array $params = array())
	{
		$namedRoutes = Router::getAllnamedRoute();
...
if ( ! function_exists('moment'))
{
	 ...
	 * @return string
	 */
	function moment($dateTime = 'now', $format = null, $locale = 'fr_FR')
	{
