 ...
 */
	...
	class HomeCommand extends Command
	{
	    ...
	    protected function execute(InputInterface $input, OutputInterface $output)
	    {
	        ...
	        $output->writeln('    <fg=green>config-convert</>	Build SQL files');
	        $output->writeln('    <fg=green>sql-build</>		Build SQL files');
	        $output->writeln('    <fg=green>sql-insert</>		Build SQL files');
	        $output->writeln('  <fg=yellow>demo</>');
	        $output->writeln('    <fg=green>demo:greet</>		Greet someone');
	        $output->writeln('  <fg=yellow>config</>');
	        $output->writeln('    <fg=green>config:convert</>	Greet someone');
